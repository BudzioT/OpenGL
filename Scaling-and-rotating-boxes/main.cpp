...
int main()
{
	...
	/* Get the place of the uniform called transform */
	...
	while (!glfwWindowShouldClose(window)) {
		...
		/* Replace the position of the square to the bottom right side of the screen, 
		rotate it by the actual time around the Z-axis */
		...
		trans = glm::mat4(1.0f);
		trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.0f));
		float scaleAmount = (float)std::sin(glfwGetTime());
